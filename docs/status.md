...
- Independent `avatar-studio/` package/application, 33 Blender parts, 11 modular categories, strict appearance/catalog contracts, atomic replacement, SHA-256 verification, bounded templates and independently disposable instances.
...
| Avatar invariants       | 54 passing tests: 217,728 structural combinations, 144 scalp-coverage states, selective hair occlusion and bounded wrapped eyewear, actual exported skin/cloth deformation, pigment integrity, asset contracts, atomic replacement and independent resource ownership.                                   |
| Avatar browser journeys | 24 passing tests: all 11 categories, collection presets and component/weight controls, 96 hair-orbit panels, illustrated rendering, sixteen-view capture, import/export/history/storage, asset failures and 40 bounded replacements.                                                                     |
...
| Art source              | Editable Blender source includes supplied and generated references, 12 isolated hair cameras and 15 collection cameras. All 33 GLBs total 1,918,808 bytes; the largest tested fitted assembly is 13,814 source triangles against the unchanged 14,000 limit. Outline rendering adds a separate pass.     |
